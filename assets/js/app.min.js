...
$(window).on("load", function() { setTimeout(function() { $(".page-loader").fadeOut() }, 500) }), $(document).ready(function() {
    ...
    if ($("#data-table")[0]) {
        $("#data-table").DataTable({
            ...
            lengthMenu: [
                [10, 25, 50, 100, -1],
                ["10 แถว", "25 แถว", "50 แถว", "100 แถว", "ทุกแถว"]
            ],
            language: { searchPlaceholder: "ค้นหา..." },
            sDom: '<"dataTables__top"lfB>rt<"dataTables__bottom"ip><"clear">',
            buttons: [{ extend: "excelHtml5", title: "Export Data" }, { extend: "csvHtml5", title: "Export Data" }, { extend: "print", title: "Report" }],
