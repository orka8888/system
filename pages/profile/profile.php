                    ...
                    <form method="post" action="sql/update.php" class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="float-right mt-10">
                                <h6 class="card-subtitle">แก้ไข - โปรไฟล์ </h6>
                            </div>
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                <div class="col-lg-4 text-center">
                                    <div class="form-group">
                                        <input type="hidden" name="image" value="<?php echo $row_session['image']; ?>">
                                        <img id="imgUpload" style="width: 200px;" src="../../assets/img/user/<?php echo  $row_session['image']; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group form-group--float">
                                        <input type="text" class="form-control" name="user_full_name" maxlength="255" value="<?php echo $row_session['user_full_name']; ?>" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group form-group--float">
                                        <input type="email" class="form-control" name="email" maxlength="100" value="<?php echo $row_session['email']; ?>" required>
                                        <label>อีเมล </label>
                                        <i class="form-group__bar"></i>
                                    </div>
                                </div> 
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group form-group--float">
                                        <input type="text" class="form-control" name="tel" maxlength="30" value="<?php echo $row_session['tel']; ?>" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group" style="top: 17px;">
                                        ...
                                        <select class="select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="role" disabled>
                                            <option value="ผู้ใช้งาน" <?php echo $row_session['role'] == 'ผู้ใช้งาน' ? 'selected':''; ?>>ผู้ใช้งาน</option>
                                            <option value="เจ้าหน้าที่พัสดุ" <?php echo $row_session['role'] == 'เจ้าหน้าที่พัสดุ' ? 'selected':''; ?>>เจ้าหน้าที่พัสดุ</option>
                                            <option value="ผู้ดูแล" <?php echo $row_session['role'] == 'ผู้ดูแล' ? 'selected':''; ?>>ผู้ดูแล</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group" style="top: 17px;">
                                        ...
                                        <select class="select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="status" disabled>
                                            <option value="ใช้งาน" <?php echo $row_session['status'] == 'ใช้งาน' ? 'selected':''; ?>>ใช้งาน</option>
                                            <option value="ไม่ใช้งาน" <?php echo $row_session['status'] == 'ไม่ใช้งาน' ? 'selected':''; ?>>ไม่ใช้งาน</option>
                                        </select>
                                    </div>
                                </div>
                            </div>  
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <a href="profile.php" class="btn btn-danger btn-icon"><i class="fas fa-times"></i> ยกเลิก</a>	
                            </div>	
                        </div>
                    </form>
                </div>
