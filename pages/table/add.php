                    ...
                    <form method="post" action="sql/insert.php" class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="float-right mt-10">
                                <h6 class="card-subtitle"><a href="index.php">โต๊ะ </a> <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i> เพิ่ม - โต๊ะ </h6>
                            </div>

                            <h4 class="card-title">เพิ่ม - โต๊ะ </h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group form-group--float">
                                        <input type="text" class="form-control" name="table" maxlength="50" required>
                                        <label>โต๊ะ </label>
