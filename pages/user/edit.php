                    ...
                    <form method="post" action="sql/update.php" class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="float-right mt-10">
                                <h6 class="card-subtitle"><a href="index.php">ผู้ใช้งาน </a> <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i> แก้ไข - ผู้ใช้งาน </h6>
                            </div>

                            <h4 class="card-title">แก้ไข - ผู้ใช้งาน </h4>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group form-group--float">
                                        <input type="text" class="form-control" name="user_full_name" maxlength="255" value="<?php echo $row_user['user_full_name']; ?>" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group form-group--float">
                                        <input type="email" class="form-control" name="email" maxlength="100" value="<?php echo $row_user['email']; ?>" required>
                                        <label>อีเมล </label>
                                        <i class="form-group__bar"></i>
                                    </div>
                                </div> 
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group form-group--float">
                                        <input type="text" class="form-control" name="tel" maxlength="30" value="<?php echo $row_user['tel']; ?>" required>
